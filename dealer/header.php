			...
			<nav class="navbar navbar-default">
			  <div class="container-fluid">
			    <div class="navbar-header">
			      <a class="navbar-brand" href="/dealer/" style='margin-left: -20px;'>Dealer</a>
			    </div>

			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			      <ul class="nav navbar-nav">
			      	<li><a href="/dealer/">Счета</a></li>
			      	<li><a href="/dealer/monitor.php">Мониторинг</a></li>
			      	<li><a href="/dealer/terminals.php">Терминалы</a></li>
			      	<li><a href="/dealer/categories.php">Категории</a></li>
			      	<li><a href="/dealer/games.php">Игры</a></li>
			        ...
			        <li style="float: right;"><a href="/logout.php">Выход</a></li>

			        <li style="float: right;">
			        	<input type="text" placeholder="Поиск..." id="search-area">
			        </li>
			      </ul>
			    </div><!-- /.navbar-collapse -->
			  </div><!-- /.container-fluid -->
